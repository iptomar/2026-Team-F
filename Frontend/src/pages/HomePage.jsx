...
const HomePage = ({ onCreateNew, onSelectDraft }) => {
  const [drafts, setDrafts] = useState([]);
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState(null);

  // ======================================================
  // BUSCAR RASCUNHOS ASSIM QUE O COMPONENTE MONTA
  // ======================================================
  useEffect(() => {
    const fetchDrafts = async () => {
      try {
        ...
        // Filtrar apenas os rascunhos
        const draftTemplates = allTemplates.filter(template => template.status === 'draft');
